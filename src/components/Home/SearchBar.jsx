...
const SearchBar = ({  
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='relative'
      >
        <input type="text" value={searchTerm} onChange={handlesearch} placeholder="Search..." className={`flex-1 block w-${width} appearance-none leading-5 transition duration-150 ease-in-out px-10 py-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:shadow-outline-blue sm:text-sm sm:leading-5`}
