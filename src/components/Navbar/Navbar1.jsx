        ...
        className="text-white cursor-pointer" />
          ...
          {!isLoggedIn && (
            <div className="flex items-center lg:order-2">
              <Link
                to="/login"
                className="text-gray-400 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
              >
                Log in
              </Link>
              <Link
